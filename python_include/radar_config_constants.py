...
CLRFREQ_RES = 400 # Radar and USRP frequency resolution
CFSFREQ_RES = 100 # Clear Frequency Service's Clear frequency resolution after spectral averaging (must be a divisor of CLRFREQ_RES)
